...
class GalleryApplication : Application() {
  ...
  override fun onCreate() {
    ...
    // The OpenAI benchmark server (openserver/OpenAiLlmServer) is NOT auto-started. It is toggled
    // on/off from Settings -> "Local benchmark server", so no port is opened unless the user wants it.
  }
}
